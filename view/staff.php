                            ...
                            <table class="table table-hover table-vcenter text-nowrap table_custom border-style list">
                                <tbody>
                                    <tr class="">
                                        ...
                                        <td class="text-center width40">
                                            <div class="avatar d-block">
                                                <img class="avatar" src="library/assets/images/xs/avatar4.jpg" alt="avatar">
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-center width40">
                                            <div class="avatar d-block">
                                                <img class="avatar" src="library/assets/images/xs/avatar2.jpg" alt="avatar">
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-center width40">
                                            <div class="avatar d-block">
                                                <img class="avatar" src="library/assets/images/xs/avatar3.jpg" alt="avatar">
                                            </div>
                                        </td>
                          F             <td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-center width40">
                                            <div class="avatar d-block">
                                                <img class="avatar" src="library/assets/images/xs/avatar7.jpg" alt="avatar">
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="">
                                        ...
                                        <td class="text-center width40">
                                            <div class="avatar d-block">
                                                <img class="avatar" src="library/assets/images/xs/avatar5.jpg" alt="avatar">
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="" >
                                        ...
                                        <td class="text-center width40">
                                            <div class="avatar d-block">
                                                <img class="avatar" src="library/assets/images/xs/avatar6.jpg" alt="avatar">
                                            </div>
                                        </td>
                                        <td>
                    ...
                    <div class="tab-pane fade" id="grid" role="tabpanel">
                        <div class="row row-deck">
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card " >
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3"> <img src="library/assets/images/sm/avatar1.jpg" class="rounded-circle w100" alt=""> </div>
                                        <div class="mb-2">
                                        ...
                                        <ul class="list-unstyled team-info margin-0 pt-2">
                                            ...
                                            <li><img src="library/assets/images/xs/avatar8.jpg" alt="Avatar"></li>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card ">
                                    <div class="card-body">
                                        <div class="mb-3"> <img src="library/assets/images/sm/avatar2.jpg" class="rounded-circle w100" alt=""> </div>
                                        <div class="mb-2">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card ">
                                    <div class="card-body">
                                        <div class="mb-3"> <img src="library/assets/images/sm/avatar3.jpg" class="rounded-circle w100" alt=""> </div>
                                        <div class="mb-2">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card " >
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3"> <img src="library/assets/images/sm/avatar4.jpg" class="rounded-circle w100" alt=""> </div>
                                        <div class="mb-2">
                                        ...
                                        <ul class="list-unstyled team-info margin-0 pt-2">
                                            <li><img src="library/assets/images/xs/avatar2.jpg" alt="Avatar"></li>
                                            <li><img src="library/assets/images/xs/avatar6.jpg" alt="Avatar"></li>
                                            <li><img src="library/assets/images/xs/avatar5.jpg" alt="Avatar"></li>
                                            <li><img src="library/assets/images/xs/avatar7.jpg" alt="Avatar"></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card ">
                                    <div class="card-body">
                                        <div class="mb-3"> <img src="library/assets/images/sm/avatar5.jpg" class="rounded-circle w100" alt=""> </div>
                                        <div class="mb-2">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="card ">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3"> <img src="library/assets/images/sm/avatar6.jpg" class="rounded-circle w100" alt=""> </div>
                                        <div class="mb-2">
                                            <h5 class="mb-0">Andrew Patrick</h5>
                                            <p>Aalizeethomas@info.com</p>
                                            <span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam deleniti fugit incidunt</span>
